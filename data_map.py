...
def china_total_map():
    ...
    # 设置分级颜色
    pieces = [
        {'max': 0, 'min': 0, 'label': '0', 'color': '#FFFFFF'},  #white
        {'max': 9, 'min': 1, 'label': '1-9', 'color': '#FFE5DB'}, #以下红色渐深
    ...
    ct_map = (
        Map()
        .add(series_name='累计确诊人数', data_pair=[list(z) for z in zip(province, curconfirm)], maptype="china", is_roam=False)
        .set_global_opts(
            # 配置标题
    ...
    ct_map.render("static/templates/china_map.html")
   # return ct_map
...
def global_total_map():
    ...
    pieces = [
        ...
        {'max': 999999999, 'min': 1000000, 'label': '≧1000000', 'color': '#8A0808'}
    ]

    gt_map = (
        Map()
        .add(series_name='累计确诊人数', data_pair=[list(z) for z in zip(country, curconfirm)], maptype="world", name_map=name_map, is_map_symbol_show=False, is_roam=False)
    ...
    gt_map.render("static/templates/global_map.html")
   # return gt_map
...
def china_daily_map():
    ...
    fi_map.render("static/templates/china_dialy_line.html")
    #return fi_map
...
def foreign_daily_map():
    ...
    fte_map.render("static/templates/foreign_dialy_line.html")
    #return fte_map
...
def all_map():
    ...
    #     foreign_daily_map()
    # )
    # page.render('templates/COVID-19.html')
